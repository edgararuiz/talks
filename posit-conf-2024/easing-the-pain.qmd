...
![](assets/linkedin.png){.absolute top="634" left="43" width="45"}
...
::: {.content-slide}
**Easing the pain <br/> of connecting <br/> to databases **
:::
...
:::{.custom2}
To properly connect to Databricks, you need to specify `10` arguments
:::
