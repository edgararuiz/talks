...
![](assets/qr-talk.svg){.absolute top=390 left=25 width=210}
...
<div class="benchside">
  <div class="bench bench-sm">
    <div class="row"><div class="label plat"><i class="fa-brands fa-apple"></i></div><div class="bar" style="width:16px"></div><div class="time">11 min</div></div>
    <div class="row"><div class="label plat"><i class="fa-brands fa-windows"></i></div><div class="bar" style="width:88px"></div><div class="time">61 min</div></div>
    <div class="row"><div class="label plat"><i class="fa-brands fa-linux"></i></div><div class="bar" style="width:130px"></div><div class="time">90 min</div></div>
    <div class="row fragment" data-fragment-index="2"><div class="label plat"><img class="sparkmark" src="assets/spark-logo.png"></div><div class="bar fast" style="width:8px"></div><div class="time">5 min</div></div>
    <div class="row fragment" data-fragment-index="3"><div class="label plat"><img class="sparkmark" src="assets/spark-logo.png"></div><div class="bar fast" style="width:4px"></div><div class="time">2.8 min</div></div>
  </div>
