...
![](assets/qr-talk.svg){.absolute top=370 left=25 width=210}

::: {.squig-arrow .absolute top=440 left=250 width=88}
```{=html}
<svg viewBox="0 0 120 90" xmlns="http://www.w3.org/2000/svg">
  <path d="M100,85 C103,56 96,31 60,25 C42,22 26,24 16,25"/>
  <polygon points="2,25 22,14 22,36"/>
</svg>
```
:::

::: {.qrnote .absolute top=518 left=278 width=220}
Link to  
the repo
:::
...
## For example {.lower-stack background-image="assets/slide-frame.png" background-size="contain" background-color="white"}
  ...
  <div>
    <div class="fragment" data-fragment-index="2">
      ...
      <div class="bench bench-sm">
        <div class="row"><div class="label plat"><i class="fa-brands fa-windows"></i></div><div class="cores">4 cores<br>4 threads</div><div class="bar" style="width:360px"></div><div class="time">61 min</div></div>
        <div class="row"><div class="label plat"><i class="fa-brands fa-linux"></i></div><div class="cores">8 cores</div><div class="bar" style="width:171px"></div><div class="time">29 min</div></div>
      </div>
    </div>
...
## {background-image="assets/slide-frame.png" background-size="contain" background-color="white"}

```{=html}
<div class="eyebrow">The problem</div>
```

::: {.goal-line .absolute top=270 left=40 width=560}
We need more speed!
:::

![](assets/battle-speed.jpg){.absolute top=100 left=670 width=550}

::: {.figref .absolute top=632 left=670 width=550}
Ben Hur, 1959
:::

## Usual solutions have barriers {background-image="assets/slide-frame.png" background-size="contain" background-color="white"}
...
<div class="barcap">
  <div class="fragment fade-in-then-out" data-fragment-index="1">Bound by cores</div>
  <div class="fragment fade-in-then-out" data-fragment-index="2">Expensive &amp; needs a code re-write</div>
  <div class="fragment fade-in-then-out" data-fragment-index="3">Complex &amp; needs a code re-write</div>
  <div class="fragment fade-in-then-out" data-fragment-index="4">Bound by cores</div>
</div>
```
...
::: {.column width="40%"}
::: {.bluecard .fragment data-fragment-index="2"}
| Spark Cluster          |
|:----------------------:|
| **32** cores available |
:::
...
<div class="iconlist">
  ...
  <div class="il-row fragment" data-fragment-index="1">
    ...
    <p>Spin up and tear down Spark clusters easily</p>
  </div>
  ...
  <div class="il-row fragment" data-fragment-index="2">
    ...
    <p>Run jobs from your own IDE, no notebooks</p>
  </div>
  ...
  <div class="il-row fragment" data-fragment-index="3">
    ...
    <p>Native R runtime and packages, in <b>Dedicated</b> mode</p>
  </div>
...
## Prepare locally, run remotely {background-image="assets/slide-frame.png" background-size="contain" background-color="white"}
...
:::::: {.fragment .fade-out .sample-mini fragment-index=2}
```r
tune_grid(
  object = spec_bt,
  preprocessor = recipe_basic,
...
:::::: {.fragment .sample-mini fragment-index=3}
```r
tune_grid_spark(
  object = spec_bt,
  preprocessor = recipe_basic,
...
<div class="benchside">
  <div class="bench bench-sm">
    <div class="row"><div class="label plat"><i class="fa-brands fa-windows"></i></div><div class="bar" style="width:130px"></div><div class="time">61 min</div></div>
    <div class="row"><div class="label plat"><i class="fa-brands fa-linux"></i></div><div class="bar" style="width:62px"></div><div class="time">29 min</div></div>
    <div class="row fragment" data-fragment-index="2"><div class="label plat"><img class="sparkmark" src="assets/spark-logo.png"></div><div class="bar fast" style="width:11px"></div><div class="time">5 min</div></div>
    <div class="row fragment" data-fragment-index="3"><div class="label plat"><img class="sparkmark" src="assets/spark-logo.png"></div><div class="bar fast" style="width:6px"></div><div class="time">2.8 min</div></div>
  </div>
  <div class="darkcard bluecard fragment" data-fragment-index="1">
    <table>
      <thead><tr><th style="text-align: center;">Spark Cluster</th></tr></thead>
      <tbody><tr><td style="text-align: center;"><strong>32</strong> cores available</td></tr></tbody>
    </table>
  </div>
</div>
```
