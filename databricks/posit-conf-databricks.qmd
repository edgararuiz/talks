...
`sparklyr` 1.8.3, along with `pysparklyr`, supports Databricks Connect "v2":
...
## Posit Workbench! {background-image="assets/slide-frame.png" background-size="1500px" background-color="white"}
