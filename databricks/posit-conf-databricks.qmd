...
## Get started easy {background-image="assets/slide-frame.png" background-size="1500px" background-color="white"}

Create the Python environment that contains the needed libraries with one command:
...
#> Requirement already satisfied: pip in /Users/edgar/.virtualenvs/r-sparklyr/lib/python3.10/site-packages (23.0.1)
#> Collecting pip
...
## Going further using *reticulate* {background-image="assets/slide-frame.png" background-size="1500px" background-color="white"}
