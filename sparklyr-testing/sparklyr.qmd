...
-   Problem
-   Not blaming
    -   Goals and coding of the package are large and complex -NOTE: maybe compare number of lines of code and number of tests with a familiar package (dplyr, ggplot2)
