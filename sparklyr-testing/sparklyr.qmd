...
`setup.R` runs before the reporter, so even the RStudio integrated screen respects
the initialization
...
Even running sub-sets of tests will initialize and terminate in the same, 
consistent way.
