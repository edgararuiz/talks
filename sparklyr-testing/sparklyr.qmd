...
- Custom Reporter
- Filters for which tests to run depending on environment 
- Custom function that controls what tests to run, passes the 
custom reporter, and tears down the Spark sessoin after exit
