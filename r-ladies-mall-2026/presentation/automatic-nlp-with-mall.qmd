...
title-slide-attributes:
  data-background-image: "images/mall.png, images/qr-cloud.png"
  data-background-size: "160px, 130px"
  data-background-position: "50% 6%, 50% 95%"
...
#| include: false
library(qrcode)
qr <- qr_code("https://edgararuiz-automatic-nlp-mall-presentation.share.connect.posit.cloud/")
png("images/qr-cloud.png", width = 300, height = 300)
plot(qr)
dev.off()
```
...
#| fig-height: 2.5
library(qrcode)
qr_code("https://edgararuiz-automatic-nlp-mall-presentation.share.connect.posit.cloud/") |> plot()
```
:::
:::
