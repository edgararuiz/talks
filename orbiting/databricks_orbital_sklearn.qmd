...
The [Databricks SDK](https://docs.databricks.com/aws/en/dev-tools/sdk-python) 
allows us to programmatically create a new [Databricks Job](https://docs.databricks.com/aws/en/jobs/)
that runs the query on a daily basis to get the current list of loans that
may have a problem. 
...
will appear in the Queries secion of the Databricks Web UI. 
...
5.  A Databricks Job can be used to orquestrate multiple taks. The job being
...
a `CronSchedule` object is needed.
